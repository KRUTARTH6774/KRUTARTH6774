# 👋 Hi there, I’m Krutarth Chaudhari
<p align="center">
  <a href="https://github.com/KRUTARTH6774">
    <img src="https://komarev.com/ghpvc/?username=KRUTARTH6774&color=brightgreen" alt="Profile views" />
  </a>
  <a href="https://github.com/KRUTARTH6774?tab=followers">
    <img src="https://img.shields.io/github/followers/KRUTARTH6774?label=Follow&style=social" alt="GitHub followers" />
  </a>
</p>

## 🔍 Overview

I'm a Master's student in Computer Science at Syracuse University, dedicated to building precise, scalable systems with expertise in:

- 🧩 High-Performance C++ & Multithreading
- 🛰️ Decentralized Blockchain Applications (Ethereum DApps)
- 📉 Machine Learning & Predictive Modeling
- 🖥️ Modern Web Development (React, TypeScript, Tailwind)

🗺️ When off the digital grid, you’ll find me exploring trails, capturing landscapes, or experimenting with tech gadgets.
...
- 📌 **Decentralized Task Marketplace** _(Jan '25 – May '25)_
  - Ethereum, Solidity, React, Tailwind

- 📌 **SPX Forecasting (Ensemble ML)** _(Jan '25 – Apr '25)_
  - Random Forest, XGBoost, SARIMA

- 📌 **Environmental Sound Classification** _(Oct '22 – Dec '22)_
  - CNN, PyTorch, Mel-spectrograms

- 📌 **Modulation Classification** _(Oct '21 – Dec '21)_
  - AlexNet, Signal Processing, PyTorch
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com?user=KRUTARTH6774&theme=algolia&date_format=M%20j%5B%2C%20Y%5D" alt="GitHub Streak" />
</p>

---

🔧 _"Precision engineered for performance and innovation."_ 🔧
